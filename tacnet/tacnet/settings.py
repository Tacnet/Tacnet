...
DATABASES = {
    'default': {
        ...
        'NAME': makepath('tacnet.db'),                      # Or path to database file if using sqlite3.
...
STATICFILES_DIRS = (
    ...
    "/home/tacnet-www/www/tacnet/apps/base/static",
    "/home/tacnet-www/www/tacnet/apps/tacsketch/static",
)
