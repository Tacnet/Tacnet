...
C,s-z);A=Math.atan2(A-C,x-z)-s;0>A&&1===n?A+=2*Math.PI:0<A&&0===n&&(A-=2*Math.PI);t=Math.ceil(Math.abs(A/(0.5*Math.PI+0.001)));x=[];for(r=0;r<t;r++)x[r]=[z,C,s+r*A/t,s+(r+1)*A/t,e,g,v,u];return b[c]=x}function e(d,b,e,g,m,n,p,q){c=a.call(arguments);if(f[c])return f[c];var w=q*m,s=-p*n,t=p*m,x=q*n,A=0.5*(g-e),v=8/3*Math.sin(0.5*A)*Math.sin(0.5*A)/Math.sin(A),A=d+Math.cos(e)-v*Math.sin(e),u=b+Math.sin(e)+v*Math.cos(e),r=d+Math.cos(g),z=b+Math.sin(g),C=r+v*Math.sin(g),v=z-v*Math.cos(g);f[c]=[w*A+s*u,
t*A+x*u,w*C+s*v,t*C+x*v,w*r+s*z,t*r+x*z];return f[c]}var b={},f={},a=Array.prototype.join,c;fabric.util.drawArc=function(d,a,c,b){a=g(b[5],b[6],b[0],b[1],b[3],b[4],b[2],a,c);for(c=0;c<a.length;c++)b=e.apply(this,a[c]),d.bezierCurveTo.apply(d,b)}})();
...
"").split(/\s*;\s*/);a[d]||(a[d]={});for(var b=0,f=c.length;b<f;b++){var e=c[b].split(/\s*:\s*/);a[d][e[0]]=e[1]}});return a},loadSVGFromURL:function(d,a,c){function b(f){var e=f.responseXML;!e.documentElement&&h.window.ActiveXObject&&f.responseText&&(e=new ActiveXObject("Microsoft.XMLDOM"),e.async="false",e.loadXML(f.responseText.replace(/<!DOCTYPE[\s\S]*?(\[[\s\S]*\])*?>/i,"")));e.documentElement&&h.parseSVGDocument(e.documentElement,function(c,b){x.set(d,{objects:h.util.array.invoke(c,"toObject"),
...
return this},toDatalessJSON:function(a){return this.toDatalessObject(a)},toObject:function(a){return this._toObjectMethod("toObject",a)},toDatalessObject:function(a){return this._toObjectMethod("toDatalessObject",a)},_toObjectMethod:function(a,c){var d=this.getActiveGroup();d&&this.discardActiveGroup();var b={objects:this._toObjects(a,c)};g(b,this.__serializeBgOverlay());fabric.util.populateWithProperties(this,b,c);d&&(this.setActiveGroup(new fabric.Group(d.getObjects())),d.forEachObject(function(d){d.set("active",
!0)}));return b},_toObjects:function(a,c){return this.getObjects().map(function(d){return this._toObject(d,a,c)},this)},_toObject:function(a,c,d){var b;this.includeDefaultValues||(b=a.includeDefaultValues,a.includeDefaultValues=!1);c=a[c](d);this.includeDefaultValues||(a.includeDefaultValues=b);return c},__serializeBgOverlay:function(){var a={background:this.backgroundColor&&this.backgroundColor.toObject?this.backgroundColor.toObject():this.backgroundColor};this.overlayColor&&(a.overlay=this.overlayColor.toObject?
this.overlayColor.toObject():this.overlayColor);this.backgroundImage&&(a.backgroundImage=this.backgroundImage.toObject());this.overlayImage&&(a.overlayImage=this.overlayImage.toObject());return a},toSVG:function(a,c){a||(a={});var d=[];this._setSVGPreamble(d,a);this._setSVGHeader(d,a);this._setSVGBgOverlayColor(d,"backgroundColor");this._setSVGBgOverlayImage(d,"backgroundImage");this._setSVGObjects(d,c);this._setSVGBgOverlayColor(d,"overlayColor");this._setSVGBgOverlayImage(d,"overlayImage");d.push("</svg>");
return d.join("")},_setSVGPreamble:function(a,c){c.suppressPreamble||a.push('<?xml version="1.0" encoding="',c.encoding||"UTF-8",'" standalone="no" ?>','<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" ','"http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">\n')},_setSVGHeader:function(a,c){a.push("<svg ",'xmlns="http://www.w3.org/2000/svg" ','xmlns:xlink="http://www.w3.org/1999/xlink" ','version="1.1" ','width="',c.viewBox?c.viewBox.width:this.width,'" ','height="',c.viewBox?c.viewBox.height:this.height,
'" ',this.backgroundColor&&!this.backgroundColor.toLive?'style="background-color: '+this.backgroundColor+'" ':null,c.viewBox?'viewBox="'+c.viewBox.x+" "+c.viewBox.y+" "+c.viewBox.width+" "+c.viewBox.height+'" ':null,'xml:space="preserve">',"<desc>Created with Fabric.js ",fabric.version,"</desc>","<defs>",fabric.createSVGFontFacesMarkup(this.getObjects()),fabric.createSVGRefElementsMarkup(this),"</defs>")},_setSVGObjects:function(a,c){var d=this.getActiveGroup();d&&this.discardActiveGroup();for(var b=
0,f=this.getObjects(),e=f.length;b<e;b++)a.push(f[b].toSVG(c));d&&(this.setActiveGroup(new fabric.Group(d.getObjects())),d.forEachObject(function(d){d.set("active",!0)}))},_setSVGBgOverlayImage:function(a,c){this[c]&&this[c].toSVG&&a.push(this[c].toSVG())},_setSVGBgOverlayColor:function(a,c){this[c]&&this[c].source?a.push('<rect x="',this[c].offsetX,'" y="',this[c].offsetY,'" ','width="',"repeat-y"===this[c].repeat||"no-repeat"===this[c].repeat?this[c].source.width:this.width,'" height="',"repeat-x"===
this[c].repeat||"no-repeat"===this[c].repeat?this[c].source.height:this.height,'" fill="url(#'+c+'Pattern)"',"></rect>"):this[c]&&"overlayColor"===c&&a.push('<rect x="0" y="0" ','width="',this.width,'" height="',this.height,'" fill="',this[c],'"',"></rect>")},sendToBack:function(a){b(this._objects,a);this._objects.unshift(a);return this.renderAll&&this.renderAll()},bringToFront:function(a){b(this._objects,a);this._objects.push(a);return this.renderAll&&this.renderAll()},sendBackwards:function(a,c){var d=
this._objects.indexOf(a);0!==d&&(d=this._findNewLowerIndex(a,d,c),b(this._objects,a),this._objects.splice(d,0,a),this.renderAll&&this.renderAll());return this},_findNewLowerIndex:function(a,c,d){if(d)for(d=c,c-=1;0<=c;--c){if(a.intersectsWithObject(this._objects[c])||a.isContainedWithinObject(this._objects[c])||this._objects[c].isContainedWithinObject(a)){d=c;break}}else d=c-1;return d},bringForward:function(a,c){var d=this._objects.indexOf(a);d!==this._objects.length-1&&(d=this._findNewUpperIndex(a,
d,c),b(this._objects,a),this._objects.splice(d,0,a),this.renderAll&&this.renderAll());return this},_findNewUpperIndex:function(a,c,d){if(d)for(d=c,c+=1;c<this._objects.length;++c){if(a.intersectsWithObject(this._objects[c])||a.isContainedWithinObject(this._objects[c])||this._objects[c].isContainedWithinObject(a)){d=c;break}}else d=c+1;return d},moveTo:function(a,c){b(this._objects,a);this._objects.splice(c,0,a);return this.renderAll&&this.renderAll()},dispose:function(){this.clear();this.interactive&&
this.removeListeners();return this},toString:function(){return"#<fabric.Canvas ("+this.complexity()+"): { objects: "+this.getObjects().length+" }>"}});g(fabric.StaticCanvas.prototype,fabric.Observable);g(fabric.StaticCanvas.prototype,fabric.Collection);g(fabric.StaticCanvas.prototype,fabric.DataURLExporter);g(fabric.StaticCanvas,{EMPTY_JSON:'{"objects": [], "background": "white"}',supports:function(a){var c=fabric.util.createCanvasElement();if(!c||!c.getContext)return null;var d=c.getContext("2d");
if(!d)return null;switch(a){case "getImageData":return"undefined"!==typeof d.getImageData;case "setLineDash":return"undefined"!==typeof d.setLineDash;case "toDataURL":return"undefined"!==typeof c.toDataURL;case "toDataURLWithQuality":try{return c.toDataURL("image/jpeg",0),!0}catch(b){}return!1;default:return null}}});fabric.StaticCanvas.prototype.toJSON=fabric.StaticCanvas.prototype.toObject}})();
...
this.lastRenderedObjectWithControlsAboveOverlay&&this.lastRenderedObjectWithControlsAboveOverlay.visible&&this.containsPoint(d,this.lastRenderedObjectWithControlsAboveOverlay)&&this.lastRenderedObjectWithControlsAboveOverlay._findTargetCorner(d,this._offset)},findTarget:function(d,a){if(!this.skipTargetFind){if(this._isLastRenderedObject(d))return this.lastRenderedObjectWithControlsAboveOverlay;var c=this.getActiveGroup();return c&&!a&&this.containsPoint(d,c)?c:this._searchPossibleTargets(d)}},_searchPossibleTargets:function(d){for(var a=
[],c,b=this.getPointer(d),b=this._objects.length;b--;)if(this._objects[b]&&this._objects[b].visible&&this._objects[b].evented&&this.containsPoint(d,this._objects[b]))if(this.perPixelTargetFind||this._objects[b].perPixelTargetFind)a[a.length]=this._objects[b];else{this.relatedTarget=c=this._objects[b];break}for(var f=0,e=a.length;f<e;f++)if(b=this.getPointer(d),!this.isTargetTransparent(a[f],b.x,b.y)){this.relatedTarget=c=a[f];break}return c},getPointer:function(d){d=g(d,this.upperCanvasEl);return{x:d.x-
this._offset.left,y:d.y-this._offset.top}},_createUpperCanvas:function(){var d=this.lowerCanvasEl.className.replace(/\s*lower-canvas\s*/,"");this.upperCanvasEl=this._createCanvasElement();fabric.util.addClass(this.upperCanvasEl,"upper-canvas "+d);this.wrapperEl.appendChild(this.upperCanvasEl);this._copyCanvasStyle(this.lowerCanvasEl,this.upperCanvasEl);this._applyCanvasStyle(this.upperCanvasEl);this.contextTop=this.upperCanvasEl.getContext("2d")},_createCacheCanvas:function(){this.cacheCanvasEl=this._createCanvasElement();
this.cacheCanvasEl.setAttribute("width",this.width);this.cacheCanvasEl.setAttribute("height",this.height);this.contextCache=this.cacheCanvasEl.getContext("2d")},_initWrapperElement:function(){this.wrapperEl=fabric.util.wrapElement(this.lowerCanvasEl,"div",{"class":this.containerClass});fabric.util.setStyle(this.wrapperEl,{width:this.getWidth()+"px",height:this.getHeight()+"px",position:"absolute"});fabric.util.makeElementUnselectable(this.wrapperEl)},_applyCanvasStyle:function(d){var a=this.getWidth()||
d.width,c=this.getHeight()||d.height;fabric.util.setStyle(d,{position:"absolute",width:a+"px",height:c+"px",left:0,top:0});d.width=a;d.height=c;fabric.util.makeElementUnselectable(d)},_copyCanvasStyle:function(d,a){a.style.cssText=d.style.cssText},getSelectionContext:function(){return this.contextTop},getSelectionElement:function(){return this.upperCanvasEl},_setActiveObject:function(d){this._activeObject&&this._activeObject.set("active",!1);this._activeObject=d;d.set("active",!0)},setActiveObject:function(d,
a){this._setActiveObject(d);this.renderAll();this.fire("object:selected",{target:d,e:a});d.fire("selected",{e:a});return this},getActiveObject:function(){return this._activeObject},_discardActiveObject:function(){this._activeObject&&this._activeObject.set("active",!1);this._activeObject=null},discardActiveObject:function(d){this._discardActiveObject();this.renderAll();this.fire("selection:cleared",{e:d});return this},_setActiveGroup:function(d){if(this._activeGroup=d)d.canvas=this,d.set("active",
!0)},setActiveGroup:function(d,a){this._setActiveGroup(d);d&&(this.fire("object:selected",{target:d,e:a}),d.fire("selected",{e:a}));return this},getActiveGroup:function(){return this._activeGroup},_discardActiveGroup:function(){var d=this.getActiveGroup();d&&d.destroy();this.setActiveGroup(null)},discardActiveGroup:function(d){this._discardActiveGroup();this.fire("selection:cleared",{e:d});return this},deactivateAll:function(){for(var d=this.getObjects(),a=0,c=d.length;a<c;a++)d[a].set("active",!1);
this._discardActiveGroup();this._discardActiveObject();return this},deactivateAllWithDispatch:function(d){var a=this.getActiveGroup()||this.getActiveObject();a&&this.fire("before:selection:cleared",{target:a,e:d});this.deactivateAll();a&&this.fire("selection:cleared",{e:d});return this},drawControls:function(d){var a=this.getActiveGroup();a?this._drawGroupControls(d,a):this._drawObjectsControls(d)},_drawGroupControls:function(a,c){this._drawControls(a,c,"Group")},_drawObjectsControls:function(a){for(var c=
0,b=this._objects.length;c<b;++c)this._objects[c]&&this._objects[c].active&&(this._drawControls(a,this._objects[c],"Object"),this.lastRenderedObjectWithControlsAboveOverlay=this._objects[c])},_drawControls:function(a,c,b){a.save();fabric[b].prototype.transform.call(c,a);c.drawBorders(a).drawControls(a);a.restore()}});for(var c in fabric.StaticCanvas)"prototype"!==c&&(fabric.Canvas[c]=fabric.StaticCanvas[c]);fabric.isTouchSupported&&(fabric.Canvas.prototype._setCursorFromEvent=function(){});fabric.Element=
fabric.Canvas})();
...
a[0].toLowerCase()&&(l=!0);a=this._getXY(a,l,g);d=parseInt(a.x,10);isNaN(d)||c.push(d);d=parseInt(a.y,10);isNaN(d)||f.push(d)},_getXY:function(a,d,c){var f=d?c.x+e(a):"V"===a[0]?c.x:e(a);a=d?c.y+b(a):"H"===a[0]?c.y:b(a);return{x:f,y:a}}}),a.Path.fromObject=function(b,d){"string"===typeof b.path?a.loadSVGFromURL(b.path,function(c){c=c[0];var e=b.path;delete b.path;a.util.object.extend(c,b);c.setSourcePath(e);d(c)}):d(new a.Path(b.path,b))},a.Path.ATTRIBUTE_NAMES=a.SHARED_ATTRIBUTES.concat(["d"]),a.Path.fromElement=
function(b,d,c){b=a.parseAttributes(b,a.Path.ATTRIBUTE_NAMES);d&&d(new a.Path(b.d,l(b,c)))},a.Path.async=!0)})("undefined"!==typeof exports?exports:this);
...
c(this.fontSize*this.lineHeight-this.fontSize/2);-1<this.textDecoration.indexOf("overline")&&c(this.fontSize*this.lineHeight-this.fontSize)}},_getFontDeclaration:function(){return[e.isLikelyNode?this.fontWeight:this.fontStyle,e.isLikelyNode?this.fontStyle:this.fontWeight,this.fontSize+"px",e.isLikelyNode?'"'+this.fontFamily+'"':this.fontFamily].join(" ")},render:function(a,b){this.visible&&(a.save(),this._render(a),!b&&this.active&&(this.drawBorders(a),this.drawControls(a)),a.restore())},toObject:function(a){a=
b(this.callSuper("toObject",a),{text:this.text,fontSize:this.fontSize,fontWeight:this.fontWeight,fontFamily:this.fontFamily,fontStyle:this.fontStyle,lineHeight:this.lineHeight,textDecoration:this.textDecoration,textAlign:this.textAlign,path:this.path,textBackgroundColor:this.textBackgroundColor,useNative:this.useNative});this.includeDefaultValues||this._removeDefaultValues(a);return a},toSVG:function(a){var b=[],c=this.text.split(this._reNewline),e=this._getSVGLeftTopOffsets(c),f=this._getSVGTextAndBg(e.lineTop,
e.textLeft,c),c=this._getSVGShadows(e.lineTop,c);e.textTop+=this._fontAscent?this._fontAscent/5*this.lineHeight:0;this._wrapSVGTextAndBg(b,f,c,e);return a?a(b.join("")):b.join("")},_getSVGLeftTopOffsets:function(a){return{textLeft:-(this.width/2),textTop:this.useNative?this.fontSize-1:this.height/2-a.length*this.fontSize-this._totalLineHeight,lineTop:this.useNative?this.fontSize*this.lineHeight:-this._fontAscent-this._fontAscent/5*this.lineHeight}},_wrapSVGTextAndBg:function(b,c,e,f){b.push('<g transform="',
this.getSvgTransform(),'">',c.textBgRects.join(""),"<text ",this.fontFamily?'font-family="'+this.fontFamily.replace(/"/g,"'")+'" ':"",this.fontSize?'font-size="'+this.fontSize+'" ':"",this.fontStyle?'font-style="'+this.fontStyle+'" ':"",this.fontWeight?'font-weight="'+this.fontWeight+'" ':"",this.textDecoration?'text-decoration="'+this.textDecoration+'" ':"",'style="',this.getSvgStyles(),'" ','transform="translate(',a(f.textLeft,2)," ",a(f.textTop,2),')">',e.join(""),c.textSpans.join(""),"</text>",
"</g>")},_getSVGShadows:function(b,c){var f=[],g,m,n=1;if(!this.shadow||!this._boundaries)return f;g=0;for(m=c.length;g<m;g++)""!==c[g]?(f.push('<tspan x="',a((this._boundaries&&this._boundaries[g]?this._boundaries[g].left:0)+n+this.shadow.offsetX,2),0===g||this.useNative?'" y':'" dy','="',a(this.useNative?b*g-this.height/2+this.shadow.offsetY:b+(0===g?this.shadow.offsetY:0),2),'" ',this._getFillAttributes(this.shadow.color),">",e.util.string.escapeXml(c[g]),"</tspan>"),n=1):n++;return f},_getSVGTextAndBg:function(a,
b,c){var e=[],f=[],g=1;this._setSVGBg(f);for(var p=0,q=c.length;p<q;p++)""!==c[p]?(this._setSVGTextLineText(c[p],p,e,a,g,f),g=1):g++,this.textBackgroundColor&&this._boundaries&&this._setSVGTextLineBg(f,p,b,a);return{textSpans:e,textBgRects:f}},_setSVGTextLineText:function(b,c,f,g,m){var n=this._boundaries&&this._boundaries[c]?a(this._boundaries[c].left,2):0;f.push('<tspan x="',n,'" ',0===c||this.useNative?"y":"dy",'="',a(this.useNative?g*c-this.height/2:g*m,2),'" ',this._getFillAttributes(this.fill),
">",e.util.string.escapeXml(b),"</tspan>")},_setSVGTextLineBg:function(b,c,e,f){b.push("<rect ",this._getFillAttributes(this.textBackgroundColor),' x="',a(e+this._boundaries[c].left,2),'" y="',a(f*c-this.height/2,2),'" width="',a(this._boundaries[c].width,2),'" height="',a(this._boundaries[c].height,2),'"></rect>')},_setSVGBg:function(b){this.backgroundColor&&this._boundaries&&b.push("<rect ",this._getFillAttributes(this.backgroundColor),' x="',a(-this.width/2,2),'" y="',a(-this.height/2,2),'" width="',
a(this.width,2),'" height="',a(this.height,2),'"></rect>')},_getFillAttributes:function(a){var b=a&&"string"===typeof a?new e.Color(a):"";return b&&b.getSource()&&1!==b.getAlpha()?'opacity="'+b.getAlpha()+'" fill="'+b.setAlpha(1).toRgb()+'"':'fill="'+a+'"'},_set:function(a,b){"fontFamily"===a&&this.path&&(this.path=this.path.replace(/(.*?)([^\/]*)(\.font\.js)/,"$1"+b+"$3"));this.callSuper("_set",a,b);a in this._dimensionAffectingProps&&(this._initDimensions(),this.setCoords())},complexity:function(){return 1}}),
e.Text.ATTRIBUTE_NAMES=e.SHARED_ATTRIBUTES.concat("x y font-family font-style font-weight font-size text-decoration".split(" ")),e.Text.fromElement=function(a,b){if(!a)return null;var c=e.parseAttributes(a,e.Text.ATTRIBUTE_NAMES);b=e.util.object.extend(b?e.util.object.clone(b):{},c);c=new e.Text(a.textContent,b);c.set({left:c.getLeft()+c.getWidth()/2,top:c.getTop()-c.getHeight()/2});return c},e.Text.fromObject=function(a){return new e.Text(a.text,f(a))},e.util.createAccessors(e.Text))})("undefined"!==
typeof exports?exports:this);
...
a,b);return f},_getTopOffset:function(){return fabric.Text.prototype._getTopOffset.call(this)-this.fontSize/this._fontSizeFraction},toObject:function(e){return fabric.util.object.extend(this.callSuper("toObject",e),{styles:g(this.styles)})}});fabric.IText.fromObject=function(e){return new fabric.IText(e.text,g(e))};fabric.IText.instances=[]})();
...
function(b){b.e&&e.canvas.containsPoint(b.e,e)||e.exitEditing()});this.canvas.on("mouse:up",function(){this.getObjects("i-text").forEach(function(b){b.__isMousedown=!1})});this.canvas.on("object:selected",function(){fabric.IText.prototype.exitEditingOnOthers.call(this)})},_tick:function(){var e=this;this._abortCursorAnimation||this.animate("_currentCursorOpacity",1,{duration:this.cursorDuration,onComplete:function(){e._onTickComplete()},onChange:function(){e.canvas&&e.canvas.renderAll()},abort:function(){return e._abortCursorAnimation}})},
...
this.canvas&&(this.canvas.defaultCursor=this._savedProps.defaultCursor,this.canvas.moveCursor=this._savedProps.moveCursor))},exitEditing:function(){this.isEditing=this.selected=!1;this.selectable=!0;this.selectionEnd=this.selectionStart;this.hiddenTextarea&&this.hiddenTextarea.blur();this.abortCursorAnimation();this._restoreEditingProps();this._currentCursorOpacity=0;this.fire("editing:exited");return this},_removeExtraneousStyles:function(){var e=this.text.split(this._reNewline),b;for(b in this.styles)e[b]||
delete this.styles[b]},_removeCharsFromTo:function(e,b){for(var f=b;f!==e;){var a=this.get2DCursorLocation(f).charIndex;f--;(a=this.get2DCursorLocation(f).charIndex>a)?this.removeStyleObject(a,f+1):this.removeStyleObject(0===this.get2DCursorLocation(f).charIndex,f)}this.text=this.text.slice(0,e)+this.text.slice(b)},insertChars:function(e){var b="\n"===this.text.slice(this.selectionStart,this.selectionStart+1);this.text=this.text.slice(0,this.selectionStart)+e+this.text.slice(this.selectionEnd);this.selectionStart===
this.selectionEnd?this.insertStyleObjects(e,b,this.copiedStyles):1<this.selectionEnd-this.selectionStart&&console.log("replacing MORE than 1 char");this.selectionEnd=this.selectionStart+=e.length;this.canvas&&this.canvas.renderAll().renderAll();this.setCoords();this.fire("text:changed")},insertNewlineStyleObject:function(e,b,f){this.shiftLineStyles(e,1);this.styles[e+1]||(this.styles[e+1]={});var a=this.styles[e][b-1],c={};if(f)c[0]=g(a);else for(var d in this.styles[e])parseInt(d,10)>=b&&(c[parseInt(d,
10)-b]=this.styles[e][d],delete this.styles[e][d]);this.styles[e+1]=c},insertCharStyleObject:function(e,b,f){var a=this.styles[e],c=g(a);0!==b||f||(b=1);for(var d in c){var l=parseInt(d,10);l>=b&&(a[l+1]=c[l])}this.styles[e][b]=f||g(a[b-1])},insertStyleObjects:function(e,b,f){if(!this.isEmptyStyles()){var a=this.get2DCursorLocation(),c=a.lineIndex,a=a.charIndex;this.styles[c]||(this.styles[c]={});"\n"===e?this.insertNewlineStyleObject(c,a,b):f?this._insertStyles(f):this.insertCharStyleObject(c,a)}},
_insertStyles:function(e){for(var b=0,f=e.length;b<f;b++){var a=this.get2DCursorLocation(this.selectionStart+b);this.insertCharStyleObject(a.lineIndex,a.charIndex,e[b])}},shiftLineStyles:function(e,b){var f=g(this.styles),a;for(a in this.styles){var c=parseInt(a,10);c>e&&(this.styles[c+b]=f[c])}},removeStyleObject:function(e,b){var f=this.get2DCursorLocation(b),a=f.lineIndex,f=f.charIndex;if(e){var c=this.text.split(this._reNewline)[a-1].length;this.styles[a-1]||(this.styles[a-1]={});for(f in this.styles[a])this.styles[a-
1][parseInt(f,10)+c]=this.styles[a][f];this.shiftLineStyles(a,-1)}else{(a=this.styles[a])&&delete a[f+(this.selectionStart===this.selectionEnd?-1:0)];var d=g(a);for(c in d){var l=parseInt(c,10);l>=f&&0!==l&&(a[l-1]=d[l],delete a[l])}}},insertNewline:function(){this.insertChars("\n")}})})();
...
this.text.length&&(this.selectionEnd=this.text.length),this.selectionStart=this.selectionEnd)},removeChars:function(g){this.selectionStart===this.selectionEnd?this._removeCharsNearCursor(g):this._removeCharsFromTo(this.selectionStart,this.selectionEnd);this.selectionEnd=this.selectionStart;this._removeExtraneousStyles();this.canvas&&this.canvas.renderAll().renderAll();this.setCoords();this.fire("text:changed")},_removeCharsNearCursor:function(g){0!==this.selectionStart&&(g.metaKey?(g=this.findLineBoundaryLeft(this.selectionStart),
this._removeCharsFromTo(g,this.selectionStart),this.selectionStart=g):g.altKey?(g=this.findWordBoundaryLeft(this.selectionStart),this._removeCharsFromTo(g,this.selectionStart),this.selectionStart=g):(g="\n"===this.text.slice(this.selectionStart-1,this.selectionStart),this.removeStyleObject(g),this.selectionStart--,this.text=this.text.slice(0,this.selectionStart)+this.text.slice(this.selectionStart+1)))}});
