...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TacSave'
        db.create_table(u'tacsketch_tacsave', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('gameMap', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tacsketch.Map'])),
            ('fabricData', self.gf('django.db.models.fields.TextField')()),
            ('linesData', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'tacsketch', ['TacSave'])


    def backwards(self, orm):
        # Deleting model 'TacSave'
        db.delete_table(u'tacsketch_tacsave')
    ...
    models = {
        ...
        u'tacsketch.tacsave': {
            'Meta': {'object_name': 'TacSave'},
            'datetime': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'fabricData': ('django.db.models.fields.TextField', [], {}),
            'gameMap': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tacsketch.Map']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'linesData': ('django.db.models.fields.TextField', [], {}),
